...
namespace KGM_Misafirhane
{
    public partial class rezervasyonlar : Form
    {
        ...
        public static DateTime girisTarihi = DateTime.Now;
        public static DateTime cikisTarihi = DateTime.Now;
        ...
        private void ListeleOnayBekleyen()
        {
            ...
            if (gecmis == false)
            {
                ...
                if (lstViewRezervasyonlar.SelectedItems.Count == 1)
                {
                    for (int i = 0; i <= 11; i++)
                    {
                        ...
                        if (i == 7)
                            girisTarihi = Convert.ToDateTime(items);
                        if (i == 8)
                            cikisTarihi = Convert.ToDateTime(items);
                        if (i == 9)
            ...
            if (onayBekleyen == true)
            {
                if (rezervasyonSecildiMi == true)
                {
                    ...
                    if (doluMu == "Dolu")
                    {
                        ...
                        komut.Parameters.AddWithValue("@p3", girisTarihi.ToString("yyyy/MM/dd"));
                    ...
                    else if (doluMu == "Boş")
                    {
                        ...
                        if (dialogResult == DialogResult.Yes)
                        {
                            ...
                            if (girisTarihi.ToString("yyyy/MM/dd") == bugununTarihi.ToString("yyyy/MM/dd"))
                            {
                                bg.Open();
                                ...
                                komut.Parameters.AddWithValue("@p1", girisTarihi.ToString("yyyy/MM/dd"));
                                komut.Parameters.AddWithValue("@p2", cikisTarihi.ToString("yyyy/MM/dd"));
