...
namespace KGM_Misafirhane
{
    public partial class YeniRezervasyon : Form
    {
        ...
        public static string tarihGiris = "";
        public static string tarihCikis = "";
        ...
        private void btnOnayla_Click(object sender, EventArgs e)
        {
            ...
            if (txtBxAdSoyad.Text != "" && txtBxTelefon.Text != "" && txtBxUcret.Text != "" && cmbBxKat.Text != "" && cmbBxOdaNo.Text != "" && dateTimeGiris.Text != "" && dateTimeCikis.Text != "" && cmbBxYetiskinSayisi.Text != "" && cmbBxCocukSayisi.Text != "" && cmbBxMusteriTipi.Text != "" && cmbBxOdaTuru.Text != "")
            {
                ...
                girisTarihi = dateTimeGiris.Text;
                cikisTarihi = dateTimeCikis.Text;
                ...
                tarihB = bugunkuTarih.ToString("dd/MM/yyyy");
                ...
                char ayrac3 = '.';
                string[] Tarih3 = tarihB.Split(ayrac);
                string yıl3 = Tarih3[2];
                string ay3 = Tarih3[1];
                string gun3 = Tarih3[0];
                string bugunTarih = yıl3 + "-" + ay3 + "-" + gun3;
        ...
        private void btnHesapla_Click(object sender, EventArgs e)
        {
            ...
            {
                string girisTarihi = dateTimeGiris.Text;
                char ayrac = '.';
                string[] Tarih1 = girisTarihi.Split(ayrac);
                string yıl = Tarih1[2];
                string ay = Tarih1[1];
                ...
                string cikisTarihi = dateTimeCikis.Text;
                char ayrac2 = '.';
                string[] Tarih2 = cikisTarihi.Split(ayrac2);
                string yıl2 = Tarih2[2];
                string ay2 = Tarih2[1];
        ...
        private void cmbBxKat_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SqlConnection bg = new SqlConnection(ConnectionString);
            bg.Open();
            SqlCommand cmd = new SqlCommand("select RoomNo from Rooms where RoomFloor=" + Convert.ToInt32(cmbBxKat.Text) + " and RoomTypeId in(select RoomTypeId from RoomType where TypeName='" + cmbBxOdaTuru.Text + "')", bg);
            SqlDataReader oku = cmd.ExecuteReader();
            while (oku.Read())
            {
